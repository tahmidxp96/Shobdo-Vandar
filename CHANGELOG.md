...
### Added
- Added monolingual Bangla-to-Bangla (bn-bn) dictionary target

### Changed
- Integrated crowdsourced BoiBhai JSON database
- Extended BanglaMorphologyEngine lemmatization to monolingual search
- Optimized tri-directional MOBI ebook compiling and publishing.
